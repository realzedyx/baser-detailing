          ...
          <div className="relative group">
            ...
            <div className="relative bg-black/40 backdrop-blur-xl rounded-2xl p-6 border border-white/[0.05] shadow-2xl overflow-hidden">
              ...
              <div className="text-center space-y-1 mb-5">
                ...
                >
                  Join Baser Detailing to track your bookings
                </motion.p>
              </div>
              ...
              <form onSubmit={handleSignUp} className="space-y-4">
                <motion.div className="space-y-3">
                  ...
                  >
                    <div className="relative flex items-center overflow-hidden rounded-lg">
                      <User className={`absolute left-3 w-4 h-4 transition-all duration-300 ${focusedInput === "name" ? 'text-[#CBA65C]' : 'text-white/40'}`} />
                      <Input
                        type="text"
                  ...
                  >
                    <div className="relative flex items-center overflow-hidden rounded-lg">
                      <Lock className={`absolute left-3 w-4 h-4 transition-all duration-300 ${focusedInput === "confirm" ? 'text-[#CBA65C]' : 'text-white/40'}`} />
                      <Input
                ...
                >
                  ...
                  <Link href="/signin" className="relative inline-block group/signin">
                    <span className="relative z-10 text-[#CBA65C] group-hover/signin:text-[#E4C883] transition-colors duration-300 font-medium">
                      Sign in
                    </span>
                    <span className="absolute bottom-0 left-0 w-0 h-[1px] bg-[#CBA65C] group-hover/signin:w-full transition-all duration-300" />
                  </Link>
                </motion.p>
              </form>
            </div>
