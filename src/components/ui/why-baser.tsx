...
const CARDS = [
  {
    ...
    body: "It's me on your car the entire time. No handoffs, no crew rotating through, no one rushing to clock off. You book me — I do the work.",
    highlight: false,
  },
  {
    cls: "why-card-2",
    ...
    body: "A full detail takes 4–5 hours. That's what it takes to do proper stain removal, get into every surface, and hand dry the paint without swirl marks.",
    highlight: true,
  },
  {
    cls: "why-card-3",
    icon: "📍",
    title: "I come to you",
    body: "No driving somewhere and waiting around. You go about your day and the car gets sorted in your driveway. If your spot doesn't work, I'll collect the car — complimentary.",
    highlight: false,
  },
] as const;
...
export function WhyBaserSection() {
  ...
  return (
    <section
      ...
      className="relative w-screen h-screen overflow-hidden flex flex-col items-center justify-center bg-[#0a0a0a]"
